...
<div class="author-card follow-box">
    ...
    <div class="dreamland-diff">
        ...
        <div class="list-group">
            ...
            <c:forEach items="${categorys}" var="category" varStatus="sta">
                <a onclick="changeToActive('category_${sta.index}','${category.category}',null)" class="list-group-item" id="category_${sta.index}">
    ...
    <div class="dreamland-content" style="background-color: white">
        ...
        <div id="release-dreamland" style="height: 400px;margin-top: 50px;width: 100%">
            ...
            <div style="float: left;position: absolute;top: 435px;margin-left: 20px" id="release-dreamland-div">
        ...
        <div id="update-dreamland" style="height: 400px;margin-top: 50px;width: 100%;display: none" >
            ...
            <div style="float: left;position: absolute;top: 435px;margin-left: 20px" id="update-dreamland-div">
        ...
        <div id="personal-dreamland" style="height: 400px;margin-top: 50px;width: 100%;display: none">
            ...
            <div style="float: left;position: absolute;top: 435px;margin-left: 20px" id="personal-dreamland-div">
...
<script>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(pageCate=="fail"){
                    ...
                    if(ucList!=null) {
                        $(ucList).each(function () {
                            var contHtml = " <li class='dreamland-fix'> <a href='${ctx}/watch?cid=" + this.id + "'>"+this.title+"</a>" +
                                "<a href='${ctx}/deleteContent?cid="+this.id+"'><span class='bar-delete'>删除</span></a>"
    ...
    /**
     * （1）将后台传来的集合的长度赋值给 num。
       （2）获取“关注” div 的 margin-top 的值，赋值给 tomVal。
       （3）每一个列表的长度为40px，所以将列表数量 num*40，然后加上“关注”div 的 margin-top 的初始值，因为获取到的 tomval = 510px，所以要对其进行切割，得到数字510，将相加之和赋值给hgt。
       （4）最后将 hgt+"px"重新赋值给“关注”div 的 margin-top 属性。
     */
    //回显到manage管理
    $(function () {
