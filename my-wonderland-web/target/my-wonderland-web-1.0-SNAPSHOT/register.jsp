...
<div class="zhuce_body" >
    <div class="zhuce_kong" id="dre_div">
    	<div class="zc">
        	...
        	<div class="bj_right" id="regist-right" style="height: 468px">
            	<p>使用以下账号直接登录</p>
                <div>
...
<script type="text/javascript">
   ...
   //校验密码强弱
    ...
    function CheckIntensity(pwd) {
        ...
        if(len < 6){
            $("#password_span").text("密码长度小于6位，请重新输入！").css("color","red");
        }else{
            if(/^[0-9]*$/.test(pwd) || /^[-Za-z]+$/.test(pwd)){
    ...
    $("#to_register").click(function () {
        if(!checkProtocol()){
            $("#protocol_span").text("请勾选\"阅读并桀纣梦境网用户协议\"！").css("color","red");
        }else{
            $("#protocol_span").text("");
        }
        if(checkPhone() && checkEmail() && checkPassword() && checkNickName() && checkCode() && checkProtocol()){
            $("#registerForm").submit();
        }else{
