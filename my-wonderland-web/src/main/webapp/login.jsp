                ...
                <div class="tab-pane fade in active" id="account-login">
                    <form id="normal_form" name="form" role="form" class="login-form" action="${ctx}/doLogin" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="checkbox">
                                <label >
                                    ...
                                    <input type="checkbox" name="state" id="loginstate" value="1" checked = checked> 记住账号
                                    </c:if>
                                    <c:if test="${state eq '0' || state eq null}">
                                        <input type="checkbox" name="state" value="0" id="loginstate"> 记住账号
                                    </c:if>
                        ...
                        <div class="form-group">
                            ...
                            <br/>
                            <div style="text-align: center"><a href = "register.jsp" >立即注册</a></div>
                        </div>
                    </form>
                </div>
                <!--手机登录-->
                <div class="tab-pane fade" id="phone-login">
                    <form role="form" class="login-form form-horizontal" id="phone_form" action="${ctx}/phoneLogin" method="post">
                        ...
                        <div class="form-group">
                            <label for="password" class="sr-only">密码</label>
                            <div class="col-xs-6">
                                <input type="text" id="verifyCode" name="phone_code" class="form-control" placeholder="验证码" onblur="checkPhoneCode();">
                            </div>
                            <div class="col-xs-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="checkbox col-xs-12">
                                <label>
                                    <input type="checkbox" name="hobbies"> 记住手机号
  ...
  //获取验证码
    $(function () {
        ...
        go.onclick = function(ev){
            if(!flag2){
                $("#phone_span").text("手机号码非法或未注册").css("color","red");
            }else{
                //发送短信给用户手机。。
                //发送一个http请求，通知服务器发送短信给目标用户
                var telephone = $("input[name = 'telephone']").val(); //手机号
                //用户输入手机号验证通过
